            ...
            <main className="flex h-screen flex-col items-center bg-white pb-2 text-[#5C5F5D]">
                <div className="fixed z-[100] h-[60px] bg-white w-full drop-shadow-lg border-b-solid border-b-[2px] border-b-[#00000029]">
                    ...
                    <div className="flex place-content-center w-full gap-2">
                        <label className="text-[#5C5F5D] font-bold text-[25px] pt-2">マイページ</label>
                    </div>
                </div>
                <div className="w-full bg-white px-2 mt-[60px] sm:mt-[40px] pt-7">
                ...
                <div className="flex flex-col gap-2 w-full px-7 mt-5 sm:mt-2">
                    <div className="flex gap-2 mt-4 sm:mt-2">
                        <div className="relative h-[120px] sm:h-[85px]">
                            <UserIcon className="bg-[#FEFF3F] rounded-[100px] h-full w-[120px] sm:w-[85px] px-4 py-4 " width={'85'} color="#FAFB64">
                            </UserIcon>
                            <PlusCircleIcon className="absolute bottom-0 right-0 sm:bottom-[-10px]" color="#FAFB64" width={30} />
                        </div>
                ...
                <div className="flex flex-col bg-[#E8E8E8] gap-6 sm:gap-2 w-full px-7 py-5 mt-5 sm:mt-2">
                    <div className="flex justify-between gap-3 sm:gap-1 h-[145px] sm:h-[90px]">
                        <button className="flex items-center w-[45%] rounded-lg px-5 py-5 sm:py-2 flex-col gap-3 sm:gap-1 bg-[#FAFB64]">
